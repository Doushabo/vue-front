          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a ref="mins" class="mins" @click="minsNum">-</a>
              </div>
              <div class="add">
...
<script>
  ...
  import Zoom from './Zoom/ZoomIndex.vue'
  import { mapGetters } from 'vuex';
  // import {reqPostShopCart} from "@/api/index.js"
  ...
  export default {
    ...
    methods: {
      minsNum() {
        let nowNum = this.skuNum;
        if(nowNum <2) {
          this.$refs.mins.style.PointerEvents = "none";
        } else {
          nowNum = this.skuNum--;
          return nowNum;
        }
